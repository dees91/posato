...
internal object PosatoControlDefaults {
...
internal enum class PosatoNavigationPlacement {
    Bottom,
    Sidebar,
}

internal enum class PosatoTone {
    Neutral,
    Positive,
    Caution,
    Critical,
