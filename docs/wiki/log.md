...
## [2026-09-02] correction | Redact cryptographic bundle parts

- Replaced the private bundle-parts carrier's generated byte-array
  representation with one fixed redacted string.

## [2026-09-02] correction | Bound persisted sync staging before restore
