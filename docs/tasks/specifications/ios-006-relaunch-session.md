...
- Write surface: `iosApp/iosApp/SuspendedExpiry*.swift`, `iosApp/ActivityMonitor/**`, `iosApp/iosAppTests/**`, `shared/src/iosMain/**/feature/enforcement/**`, `shared/src/iosTest/**/feature/enforcement/**`, and `docs/wiki/topics/ios-enforcement.md`; `docs/wiki/log.md` is shared by rebase. No macOS, sync, or `commonMain` session-model change; `MACOS-012` runs in parallel on documents only.
