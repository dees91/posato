...
- The site is built with Astro, and the screenshots and favicon come directly from their existing repository sources, which extends the watch paths (amends `AC-03`).
