...
| `TB-08` Source/dependency/signing chain → installed process | Code, build tools, dependencies, entitlements, signatures, updates | Review and pin inputs, minimize entitlements, verify identities and artifacts, keep credentials outside source and routine CI | `QUALITY-001`, `CI-001`, target owners, `RELEASE-001`, `RELEASE-002` |
