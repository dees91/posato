...
class RedactionTest {
    ...
    fun `rewrites every registered value wherever it appears`() {
        ...
        redaction.register("00008103-000A4D2E0A88001E")

        val line = "device 00008103-000A4D2E0A88001E of team ABCDE12345 (ABCDE12345)"
        val redacted = redaction.redact(line)

        assertFalse(redacted.contains("ABCDE12345"))
        assertFalse(redacted.contains("00008103-000A4D2E0A88001E"))
